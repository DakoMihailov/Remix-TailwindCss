...
export const Footer :React.FC = () => {
  return (
    <>
    <hr className="mt-24 block h-[1px] border-top border-gray-300 dark:border-gray-700 " />
      <Section
        className="text-gray-800 dark:text-gray-400 mt-6 pb-12"
        as="footer"
      >
        <div className="flex flex-col lg:flex-row justify-between gap-12 ">
          <div className="lg:max-w-sm">
            <H2 colorScheme="primary">Dako Mihailov</H2>
          ...
          <div className="lg:max-w-sm">
            <H2 colorScheme="primary">Submit</H2>
            <Paragraph>
